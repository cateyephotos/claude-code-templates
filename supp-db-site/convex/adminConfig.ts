  ...
  },
  {
    ...
    vars: [
      ...
      },
      {
        ...
        resolutionType: "convex_env" as const,
        resolutionHint: "In Stripe Dashboard → Developers → Webhooks → Add endpoint. URL: your Convex HTTP endpoint /stripe-webhook (e.g. https://your-deployment.convex.site/stripe-webhook). Events: checkout.session.completed, customer.subscription.updated, customer.subscription.deleted, invoice.payment_failed. Copy the Signing Secret (whsec_...) and add as STRIPE_WEBHOOK_SECRET in Convex env vars.",
      },
      {
  ...
  },
  {
    ...
    vars: [
      ...
      },
      {
        ...
        required: false,
        description: "Svix signing secret for Clerk webhook verification (whsec_...)",
        docsUrl: "https://dashboard.clerk.com/last-active?path=webhooks",
        resolutionType: "convex_env" as const,
        resolutionHint: "In Clerk Dashboard → Webhooks → Add endpoint. URL: your Convex HTTP endpoint /clerk-webhook. Copy the Signing Secret (whsec_...) and add as CLERK_WEBHOOK_SECRET in Convex env vars.",
      },
    ],
  },
  {
    ...
    vars: [
      ...
      },
      {
        ...
        required: false,
        description: "Svix signing secret for Resend webhook verification (whsec_...)",
        docsUrl: "https://resend.com/webhooks",
        resolutionType: "convex_env" as const,
        resolutionHint: "In Resend Dashboard → Webhooks → Add endpoint. URL: your Convex HTTP endpoint /resend-webhook. Copy the Signing Secret and add as RESEND_WEBHOOK_SECRET in Convex env vars.",
      },
    ],
  },
  {
    ...
    vars: [
      {
        ...
        docsUrl: "",
        resolutionType: "convex_env" as const,
        resolutionHint: "Set PDF_GENERATOR_URL in Convex env vars to the base URL of your PDF rendering service (e.g. https://yourdomain.com/pdf-api).",
      },
      {
        ...
        docsUrl: "",
        resolutionType: "convex_env" as const,
        resolutionHint: "Set PDF_GENERATOR_SECRET in Convex env vars to the shared HMAC secret used to authenticate requests with the PDF microservice.",
      },
    ],
  },
  {
    ...
    serviceIcon: "fa-server",
    serviceDescription: "Core site configuration used by multiple services",
    vars: [
      {
        key: "SITE_URL",
        label: "Site URL",
        required: false,
        description: "Public base URL — used by Stripe checkout redirects, Resend email links, and PDF generator",
        defaultValue: "http://localhost:8080",
        docsUrl: "",
        resolutionType: "convex_env" as const,
        resolutionHint: "Set SITE_URL in Convex env vars to your public deployment URL (e.g. https://supplementdb.com). Used by Stripe for checkout redirects, Resend for email links, and the PDF generator.",
      },
      {
        key: "ADMIN_BOOTSTRAP_SECRET",
        label: "Admin Bootstrap Secret",
        required: false,
        description: "One-time secret for bootstrapping the first admin user via HTTP endpoint",
        docsUrl: "",
        resolutionType: "convex_env" as const,
        resolutionHint: "Set ADMIN_BOOTSTRAP_SECRET in Convex env vars. Use it once via POST /admin-bootstrap to promote your user to admin. Change or remove after initial setup.",
      },
    ],
  },
] as const;
