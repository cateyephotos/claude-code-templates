...
window.enhancedCitations[15] = {
    ...
    evidenceProfile: {
        ...
        mode2UpdateLog: {
            ...
            newCitations: ["ginseng_ben_008 (Zeng 2024)", "ginseng_ben_009 (Kim 2025)", "ginseng_ben_010 (Jafari 2025)"],
            integrityFlags: ["3 fabricated safety citations (safety[1], safety[3], safety[4])", "Species mismatch: Vuksan 2000 references P. quinquefolius", "Ellis 2002 (benefit[3]) missing PMID and DOI"]
        }
    },
                ...
                studies: [
                    {
                        ...
                        authors: ["Geng, J.", "Dong, J.", "Ni, H.", "Lee, M.S.", "Wu, T.", "Jiang, K.", "Wang, G.", "Zhou, A.L.", "Malouf, R."],
                        year: 2010,
                ...
                studies: [
                    {
                        ...
                        authors: ["Mook-Jung, I.", "Hong, H.S.", "Boo, J.H.", "Lee, K.H.", "Yun, S.H.", "Cheong, M.Y.", "Joo, I.", "Huh, K.", "Jung, M.W."],
                        year: 2001,
                        journal: "Synapse",
                        pmid: "11169620",
                ...
                studies: [
                    {
                        ...
                        authors: ["Ramesh, T.", "Kim, S.W.", "Sung, J.H.", "Hwang, S.Y.", "Sohn, S.H.", "Yoo, S.K.", "Kim, S.K."],
                        year: 2012,
                        journal: "Nutrients",
                        pmid: "23201840",
                ...
                studies: [
                    {
                        ...
                        authors: ["Heo, J.H.", "Lee, S.T.", "Chu, K.", "Oh, M.J.", "Park, H.J.", "Shim, J.Y.", "Kim, M."],
                        year: 2008,
                ...
                studies: [
                    {
                        ...
                        authors: ["Kenarova, B.", "Neychev, H.", "Hadjiivanova, C.", "Petkov, V.D."],
                        year: 1990,
                ...
                studies: [
                    {
                        ...
                        authors: ["Reay, J.L.", "Scholey, A.B.", "Kennedy, D.O."],
                        year: 2010,
                ...
                studies: [
                    {
                        ...
                        authors: ["Zeng, M.", "Zhang, K.", "Yang, J.", "Zhang, Y.", "You, P.", "Yan, L.", "Lu, Z."],
                        year: 2024,
                        journal: "Phytotherapy Research",
                        pmid: "39474788",
                ...
                studies: [
                    {
                        ...
                        authors: ["Jafari, A.", "Mardani, H.", "Abbastabar, M.", "Mehdipoor, F.", "Parsi Nezhad, B.", "Kordkatuli, K.", "Roghani, F.", "Kheirouri, S.", "Alizadeh, M.", "Clark, C.C.T."],
                        year: 2025,
