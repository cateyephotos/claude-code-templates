    ...
    "benefits": [
      {
        ...
        "evidence": [
          ...
          },
          {
            ...
            "title": "Creatine and Cognition in Aging: A Systematic Review",
            "authors": ["Marshall RP", "Droste JN", "Gießing J", "Forbes SC"],
            "year": 2026,
      ...
      },
      {
        ...
        "evidence": [
          ...
          },
          {
            ...
            "title": "Effects of Creatine on Muscle Strength Gains During Resistance Training: A Meta-Analysis with Robust Variance Estimation",
            "authors": ["Zhang K", "Dang K", "Chen J", "Ma Y", "Li S", "Zhang K"],
            "year": 2025,
          ...
          },
          {
            ...
            "authors": ["Kazeminasab F", "Marandi SM", "Baharlooie M", "Amani-Shalamzari S", "Forbes SC", "Candow DG"],
            "year": 2025,
            "journal": "Journal of Sports Sciences",
            "volume": "",
            "issue": "",
      ...
      },
      {
        ...
        "evidence": [
          ...
          },
          {
            ...
            "evidenceLevel": "Level 1",
            "findings": "Overall effect size for lean mass: 0.36 (95% CI: 0.24-0.49, p<0.001) across 1071 participants from 22 RCTs. Greater effects in younger adults (<50 years, ES=0.41) versus older adults (ES=0.23). Males showed larger effect sizes (ES=0.45) compared to females (ES=0.16). Minimum effective dose appears to be 3g/day.",
            "methodology": "Systematic review and meta-analysis of 22 RCTs with subgroup analyses by age, sex, and exercise type"
          },
          {
            "citationId": "ashtary_larky_2025_dose_response",
            "title": "Dose-response effects of creatine supplementation on body composition: a meta-analysis",
            "authors": ["Ashtary-Larky D", "Forbes SC", "Candow DG"],
            "year": 2025,
            "journal": "Clinical Nutrition",
            "volume": "",
            "issue": "",
        ...
        "evidence": [
          {
            ...
            "studyType": "Systematic review and meta-analysis of RCTs",
            "evidenceLevel": "Level 1",
            "findings": "Older adults (>50 years) showed a significant but smaller effect size (ES=0.23) for lean mass gains with creatine supplementation compared to younger adults (ES=0.41). Benefits were still clinically meaningful and creatine may help counteract age-related sarcopenia when combined with resistance exercise.",
            "methodology": "Subgroup analysis of older adult populations within meta-analysis of 22 RCTs examining lean body mass outcomes"
          }
        ]
      },
      {
        ...
        "evidence": [
          {
            ...
            "title": "Creatine monohydrate as a treatment for depression: a systematic review and meta-analysis",
            "authors": ["Eckert A", "Gomes MC", "Lemos LN", "Mota JF"],
            "year": 2025,
        ...
        "evidence": [
          {
            ...
            "authors": ["Naeini F", "Zarezadeh M", "Mohammadi-Nasrabadi F", "Tutunchi H", "Ebrahimi-Mameghani M"],
            "year": 2025,
            "journal": "Clinical Nutrition",
            "volume": "",
            "issue": "",
