...
function processFile(filePath) {
  ...
  // Detect supplement pages early (needed for idempotency check)
  ...
  // Exception: supplement pages from seed.js have auth-buttons but may still need gate scripts
  if (html.includes('id="auth-buttons"')) {
    const needsGateScripts = isSupplementPage && !html.includes("monograph-gate.js");
    if (!needsGateScripts) {
